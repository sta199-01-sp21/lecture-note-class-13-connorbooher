...
I'd be suprised if 40--not 3--were left-handed.
...
- Population: Manhattan 1-Bedroom Manhattan Apartment
...
**Interpretation**: This means that, once the data have been bootstrapped, we 
can be 95% confident that the mean Manhattan 1-bedroom apartments falls within 
\$2299 and $2977.
...
**Interpretation**: This means that the median will fall, with 95% confidence, 
between 2162 and 2875
...
**Interpretation**: We can say with 95% confidence that the proportion of mice 
which died without treatment.
...
We can say with 95% confidence that the actual proportion of mice which died is 
between .552 and .651.
